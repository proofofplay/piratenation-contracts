...
import {MANAGER_ROLE, GAME_LOGIC_CONTRACT_ROLE, NAME_TRAIT_ID, DESCRIPTION_TRAIT_ID, IMAGE_TRAIT_ID} from "../Constants.sol";
...
abstract contract TraitsConsumerUpgradeable is
    ITraitsConsumer,
    ...
    IERC165
{
     ...
     */
    function __TraitsConsumer_init(
