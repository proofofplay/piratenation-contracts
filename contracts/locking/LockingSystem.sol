...
import {GAME_NFT_CONTRACT_ROLE, GAME_ITEMS_CONTRACT_ROLE, GAME_LOGIC_CONTRACT_ROLE, MANAGER_ROLE} from "../Constants.sol";
...
contract LockingSystem is ILockingSystem, GameRegistryConsumerUpgradeable {
     ...
     */
    function setRescueUnlockEnabled(bool _enabled) external onlyRole(MANAGER_ROLE) {
