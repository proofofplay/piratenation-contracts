...
import {ERC721ContractURIACL} from "@proofofplay/erc721-extensions/src/L2/ERC721ContractURIACL.sol";
import {ERC721BeforeTokenTransferHandlerACL} from "@proofofplay/erc721-extensions/src/L2/ERC721BeforeTokenTransferHandlerACL.sol";
...
contract GameNFTV2 is
    TraitsConsumer,
    ERC721BeforeTokenTransferHandlerACL,
    ERC721MirroredL2,
    ERC721ContractURIACL,
    IGameNFTV2
{
    ...
    function _beforeTokenTransfer(
        ...
        internal
        virtual
        override(ERC721MirroredL2, ERC721BeforeTokenTransferHandlerACL)
    {
        // Track hold time
