...
uint256 constant ID = uint256(
    keccak256("game.piratenation.piratequestrunnercomponent.v1")
);
...
library PirateQuestRunnerConfigComponentStorage {
...
/**
 * @title PirateQuestRunnerConfigComponent
 * @dev This component is used configure quests using the PirateQuestRunner. Requires that the first input is a pirate NFT.
 */
contract PirateQuestRunnerConfigComponent is BaseStorageComponentV2 {
    /** SETUP **/
     ...
     *
     * @param entity Entity to get value for
     * @param energyRequired How much energy is required for this quest
     * @param minPirateLevel Minimum required pirate level for this quest
     * @param maxPirateLevel Maxmimum allowable pirate level for this quest
     * @param minPirateGeneration Minimum required pirate generation for this quest
     * @param maxPirateGeneration Maximum allowable pirate generation for this quest
     * @param baseSuccessProbability Base probability of success for this quest
     * @param successXp Account XP reward for successful quest
     */
    function setValue(
        uint256 entity,
        uint128 energyRequired,
    ...
    function getLayoutValue(
        ...
        value = PirateQuestRunnerConfigComponentStorage
            .layout()
     ...
     *
     * @param entity Entity to get value for
     * @return energyRequired How much energy is required for this quest
     * @return minPirateLevel Minimum required pirate level for this quest
     * @return maxPirateLevel Maxmimum allowable pirate level for this quest
     * @return minPirateGeneration Minimum required pirate generation for this quest
     * @return maxPirateGeneration Maximum allowable pirate generation for this quest
     * @return baseSuccessProbability Base probability of success for this quest
     * @return successXp Account XP reward for successful quest
     */
    function getValue(
        uint256 entity
    )
    ...
    {
        if (has(entity)) {
            Layout memory s = PirateQuestRunnerConfigComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (
                energyRequired,
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = PirateQuestRunnerConfigComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete PirateQuestRunnerConfigComponentStorage
            .layout()
            .entityIdToStruct[entity];
