...
uint256 constant ID = uint256(
    keccak256("game.piratenation.int256arraycomponent.v1")
);
...
library Int256ArrayComponentStorage {
...
/**
 * @title Int256ArrayComponent
 * @dev A generic int256 array value of an entity
 */
contract Int256ArrayComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        keys[0] = "value";
        values[0] = TypesLibrary.SchemaValue.INT256_ARRAY;
    }
    ...
    function append(
        ...
        Layout storage s = Int256ArrayComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = Int256ArrayComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        uint256 entity
    ) external view virtual returns (int256[] memory value) {
        if (has(entity)) {
            Layout memory s = Int256ArrayComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (value) = abi.decode(_getEncodedValues(s), (int256[]));
        }
    }
    ...
    function getBytes(
        ...
        Layout memory s = Int256ArrayComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function setBytes(
        ...
        (s.value) = abi.decode(value, (int256[]));
    ...
    function batchSetBytes(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            ...
            (s.value) = abi.decode(values[i], (int256[]));
    ...
    function remove(
        ...
        delete Int256ArrayComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete Int256ArrayComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
