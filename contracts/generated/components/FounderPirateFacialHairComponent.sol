...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpiratefacialhaircomponent.v1")
);
...
library FounderPirateFacialHairComponentStorage {
...
/**
 * @title FounderPirateFacialHairComponent
 * @dev The facial hair of the founder pirate
 */
contract FounderPirateFacialHairComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateFacialHairComponentStorage
            .layout()
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateFacialHairComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateFacialHairComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateFacialHairComponentStorage
            .layout()
            .entityIdToStruct[entity];
