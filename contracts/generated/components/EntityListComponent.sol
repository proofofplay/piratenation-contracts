...
uint256 constant ID = uint256(
    keccak256("game.piratenation.entitylistcomponent.v1")
);
...
library EntityListComponentStorage {
...
/**
 * @title EntityListComponent
 * @dev A list of entities
 */
contract EntityListComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function append(
        ...
        Layout storage s = EntityListComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getLayoutValue(
        ...
        value = EntityListComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = EntityListComponentStorage
                .layout()
    ...
    function getBytes(
        ...
        Layout memory s = EntityListComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete EntityListComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete EntityListComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
