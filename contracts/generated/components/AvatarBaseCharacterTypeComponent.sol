...
uint256 constant ID = uint256(
    keccak256("game.piratenation.avatarbasecharactertypecomponent.v1")
);
...
library AvatarBaseCharacterTypeComponentStorage {
...
/**
 * @title AvatarBaseCharacterTypeComponent
 * @dev The base character type of the avatar
 */
contract AvatarBaseCharacterTypeComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Entity that has the character type information for this entity&#39;s avatar
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Entity that has the character type information for this entity&#39;s avatar
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = AvatarBaseCharacterTypeComponentStorage
            .layout()
     ...
     *
     * @param entity Entity to get value for
     * @return value Entity that has the character type information for this entity&#39;s avatar
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = AvatarBaseCharacterTypeComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = AvatarBaseCharacterTypeComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete AvatarBaseCharacterTypeComponentStorage
            .layout()
            .entityIdToStruct[entity];
