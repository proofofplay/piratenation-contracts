...
uint256 constant ID = uint256(
    keccak256("game.piratenation.boolarraycomponent.v1")
);
...
library BoolArrayComponentStorage {
...
/**
 * @title BoolArrayComponent
 * @dev A generic boolean array value of an entity
 */
contract BoolArrayComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        keys[0] = "value";
        values[0] = TypesLibrary.SchemaValue.BOOL_ARRAY;
    }
    ...
    function append(
        ...
        Layout storage s = BoolArrayComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getLayoutValue(
        ...
        value = BoolArrayComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        uint256 entity
    ) external view virtual returns (bool[] memory value) {
        if (has(entity)) {
            Layout memory s = BoolArrayComponentStorage
                .layout()
    ...
    function getBytes(
        ...
        Layout memory s = BoolArrayComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete BoolArrayComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete BoolArrayComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
