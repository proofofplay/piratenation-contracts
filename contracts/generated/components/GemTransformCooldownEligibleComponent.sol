...
uint256 constant ID = uint256(
    keccak256("game.piratenation.gemtransformcooldowneligiblecomponent.v1")
);
...
library GemTransformCooldownEligibleComponentStorage {
...
/**
 * @title GemTransformCooldownEligibleComponent
 * @dev Define if a transform cooldown is eligible for gems
 */
contract GemTransformCooldownEligibleComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Whether the transform cooldown is eligible for gems or not (default is false)
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Whether the transform cooldown is eligible for gems or not (default is false)
     */
    function setValue(
        uint256 entity,
        bool value
    ...
    function getLayoutValue(
        ...
        value = GemTransformCooldownEligibleComponentStorage
            .layout()
     ...
     *
     * @param entity Entity to get value for
     * @return value Whether the transform cooldown is eligible for gems or not (default is false)
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (bool value) {
        if (has(entity)) {
            Layout memory s = GemTransformCooldownEligibleComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = GemTransformCooldownEligibleComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete GemTransformCooldownEligibleComponentStorage
            .layout()
            .entityIdToStruct[entity];
