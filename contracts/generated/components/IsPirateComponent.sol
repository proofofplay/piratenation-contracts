...
uint256 constant ID = uint256(
    keccak256("game.piratenation.ispiratecomponent.v1")
);
...
library IsPirateComponentStorage {
...
/**
 * @title IsPirateComponent
 * @dev Is this entity a pirate?
 */
contract IsPirateComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Whether or not this entity is a pirate
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Whether or not this entity is a pirate
     */
    function setValue(
        uint256 entity,
        bool value
    ...
    function getLayoutValue(
        ...
        value = IsPirateComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Whether or not this entity is a pirate
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (bool value) {
        if (has(entity)) {
            Layout memory s = IsPirateComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = IsPirateComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getBytes(
        ...
        Layout memory s = IsPirateComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete IsPirateComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete IsPirateComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
