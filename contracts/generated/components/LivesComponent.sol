...
uint256 constant ID = uint256(keccak256("game.piratenation.livescomponent.v1"));
...
/**
 * @title LivesComponent
 * @dev Track an entity&#39;s lives
 */
contract LivesComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Lives amount at time of last spend
     ...
     *
     * @param entity Entity to get value for
     * @param lastLifeAmount Lives amount at time of last spend
    ...
    function getLayoutValue(
        ...
        value = LivesComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return lastLifeAmount Lives amount at time of last spend
    ...
    {
        if (has(entity)) {
            Layout memory s = LivesComponentStorage.layout().entityIdToStruct[
                entity
            ];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = LivesComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete LivesComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete LivesComponentStorage.layout().entityIdToStruct[entities[i]];
        }
