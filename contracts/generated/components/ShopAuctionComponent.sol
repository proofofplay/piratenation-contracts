...
uint256 constant ID = uint256(
    keccak256("game.piratenation.shopauctioncomponent.v1")
);
...
library ShopAuctionComponentStorage {
...
/**
 * @title ShopAuctionComponent
 * @dev Wether the Item is an Auction or not
 */
contract ShopAuctionComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // If the Item is an Auction or not
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value If the Item is an Auction or not
     */
    function setValue(
        uint256 entity,
        bool value
    ...
    function getLayoutValue(
        ...
        value = ShopAuctionComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value If the Item is an Auction or not
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (bool value) {
        if (has(entity)) {
            Layout memory s = ShopAuctionComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = ShopAuctionComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function getBytes(
        ...
        Layout memory s = ShopAuctionComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete ShopAuctionComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete ShopAuctionComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
