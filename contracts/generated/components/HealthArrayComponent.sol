...
uint256 constant ID = uint256(
    keccak256("game.piratenation.healtharraycomponent.v1")
);
...
library HealthArrayComponentStorage {
...
/**
 * @title HealthArrayComponent
 * @dev Holds an array that defines health values
 */
contract HealthArrayComponent is BaseStorageComponentV2 {
    /** SETUP **/
     ...
     *
     * @param entity Entity to get value for
     * @param value The array of health values
     */
    function setValue(
        uint256 entity,
    ...
    function append(
        ...
        Layout storage s = HealthArrayComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = HealthArrayComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value The array of health values
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256[] memory value) {
        if (has(entity)) {
            Layout memory s = HealthArrayComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getBytes(
        ...
        Layout memory s = HealthArrayComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete HealthArrayComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete HealthArrayComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
