 ...
 */
contract TransformP3R1Component is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function setValue(
        ...
        _setValue(entity, Layout(x, y, z, rotation));
    }
    ...
    function getValue(
        ...
        view
        virtual
        returns (int64 x, int64 y, int64 z, int64 rotation)
    {
        if (has(entity)) {
            Layout memory s = TransformP3R1ComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (x, y, z, rotation) = abi.decode(
                _getEncodedValues(s),
    ...
    function getByteValues(
        ...
        values[3] = abi.encode(s.rotation);
    }
    ...
    function setBytes(
        ...
        Layout memory s = TransformP3R1ComponentStorage
            .layout()
            .entityIdToStruct[entity];
        (s.x, s.y, s.z, s.rotation) = abi.decode(
            value,
            (int64, int64, int64, int64)
        );
    ...
    function _getEncodedValues(
        ...
        return abi.encode(value.x, value.y, value.z, value.rotation);
    }
}
