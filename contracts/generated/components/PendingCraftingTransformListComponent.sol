...
uint256 constant ID = uint256(
    keccak256("game.piratenation.pendingcraftingtransformlistcomponent.v1")
);
...
library PendingCraftingTransformListComponentStorage {
...
/**
 * @title PendingCraftingTransformListComponent
 * @dev Track the crafting transforms pending for an account
 */
contract PendingCraftingTransformListComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Crafting transforms pending for an account
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Crafting transforms pending for an account
     */
    function setValue(
        uint256 entity,
    ...
    function append(
        ...
        Layout storage s = PendingCraftingTransformListComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = PendingCraftingTransformListComponentStorage
            .layout()
            .entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Crafting transforms pending for an account
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256[] memory value) {
        if (has(entity)) {
            Layout memory s = PendingCraftingTransformListComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete PendingCraftingTransformListComponentStorage
            .layout()
            .entityIdToStruct[entity];
