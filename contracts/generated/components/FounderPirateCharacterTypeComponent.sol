...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpiratecharactertypecomponent.v1")
);
...
library FounderPirateCharacterTypeComponentStorage {
...
/**
 * @title FounderPirateCharacterTypeComponent
 * @dev The character type of the founder pirate
 */
contract FounderPirateCharacterTypeComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateCharacterTypeComponentStorage
            .layout()
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateCharacterTypeComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateCharacterTypeComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateCharacterTypeComponentStorage
            .layout()
            .entityIdToStruct[entity];
