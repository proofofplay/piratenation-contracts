...
uint256 constant ID = uint256(
    keccak256("game.piratenation.viplootentityreferencecomponent.v1")
);
...
library VipLootEntityReferenceComponentStorage {
...
/**
 * @title VipLootEntityReferenceComponent
 * @dev Component stores a reference to a VIP loot entity
 */
contract VipLootEntityReferenceComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // A reference to a VIP loot entity
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value A reference to a VIP loot entity
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = VipLootEntityReferenceComponentStorage
            .layout()
     ...
     *
     * @param entity Entity to get value for
     * @return value A reference to a VIP loot entity
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = VipLootEntityReferenceComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = VipLootEntityReferenceComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete VipLootEntityReferenceComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete VipLootEntityReferenceComponentStorage
                .layout()
                .entityIdToStruct[entities[i]];
        }
