...
uint256 constant ID = uint256(
    keccak256("game.piratenation.stringarraycomponent.v1")
);
...
library StringArrayComponentStorage {
...
/**
 * @title StringArrayComponent
 * @dev A generic string array value of an entity
 */
contract StringArrayComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function append(
        ...
        Layout storage s = StringArrayComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = StringArrayComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = StringArrayComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getBytes(
        ...
        Layout memory s = StringArrayComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete StringArrayComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete StringArrayComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
