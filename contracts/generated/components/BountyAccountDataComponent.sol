...
struct Layout {
    address account;
    uint256[] activeBountyIds;
}

library BountyAccountDataComponentStorage {
 ...
 */
contract BountyAccountDataComponent is BaseStorageComponentV2 {
    /** SETUP **/
     ...
     * @param activeBountyIds Array of user active bounty IDs
     */
    function setValue(
        uint256 entity,
        address account,
        ...
        _setValue(entity, Layout(account, activeBountyIds));
    }
    ...
    function getLayoutValue(
        ...
        value = BountyAccountDataComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     * @return activeBountyIds Array of user active bounty IDs
     */
    function getValue(
        uint256 entity
    )
    ...
    {
        if (has(entity)) {
            Layout memory s = BountyAccountDataComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = BountyAccountDataComponentStorage
            .layout()
            .entityIdToStruct[entity];
        ...
        values[1] = abi.encode(s.activeBountyIds);
    }
    ...
    function setBytes(
        ...
        Layout memory s = BountyAccountDataComponentStorage
            .layout()
            .entityIdToStruct[entity];
        (s.account, s.activeBountyIds) = abi.decode(
            value,
            (address, uint256[])
        );
    ...
    function remove(
        ...
        delete BountyAccountDataComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function _setValueToStorage(uint256 entity, Layout memory value) internal {
        ...
        s.activeBountyIds = value.activeBountyIds;
    }
    ...
    function _setValue(uint256 entity, Layout memory value) internal {
        ...
        // ABI Encode all native types of the struct
        _emitSetBytes(entity, abi.encode(value.account, value.activeBountyIds));
    }

    function _getEncodedValues(
        Layout memory value
    ) internal pure returns (bytes memory) {
        return abi.encode(value.account, value.activeBountyIds);
    }
}
