...
uint256 constant ID = uint256(
    keccak256("game.piratenation.accountlimitcomponent.v1")
);
...
library AccountLimitComponentStorage {
...
/**
 * @title AccountLimitComponent
 * @dev The maximum number of accounts allowed
 */
contract AccountLimitComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // The account limit for an entity
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value The account limit for an entity
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = AccountLimitComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value The account limit for an entity
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = AccountLimitComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = AccountLimitComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete AccountLimitComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete AccountLimitComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
