...
contract CheckpointComponent is BaseStorageComponentV2 {
     ...
     *
     * @param entity Entity to get value for
     * @param numOfCheckpoints Number of total checkpoints part of this checkpoint
     * @param checkpointPosition Position of this checkpoint
     * @param groupId Group Id of this checkpoint
     */
    function setValue(
        uint256 entity,
        uint64 numOfCheckpoints,
        ...
        _setValue(
            entity,
            Layout(numOfCheckpoints, checkpointPosition, groupId)
        );
    }
     ...
     *
     * @param entity Entity to get value for
     * @return numOfCheckpoints Number of total checkpoints part of this checkpoint
     * @return checkpointPosition Position of this checkpoint
     * @return groupId Group Id of this checkpoint
     */
    function getValue(
        uint256 entity
    )
        ...
        )
    {
        if (has(entity)) {
            ...
            (numOfCheckpoints, checkpointPosition, groupId) = abi.decode(
                _getEncodedValues(s),
