...
uint256 constant ID = uint256(
    keccak256("game.piratenation.craftingbuildingtransformconfigcomponent.v1")
);
...
library CraftingBuildingTransformConfigComponentStorage {
...
/**
 * @title CraftingBuildingTransformConfigComponent
 * @dev This component defines rules for a Crafting Building transform.
 */
contract CraftingBuildingTransformConfigComponent is BaseStorageComponentV2 {
    /** SETUP **/
     ...
     *
     * @param entity Entity to get value for
     * @param value A list of valid crafting building entities for this runner
     */
    function setValue(
        uint256 entity,
    ...
    function append(
        ...
        Layout storage s = CraftingBuildingTransformConfigComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = CraftingBuildingTransformConfigComponentStorage
            .layout()
            .entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value A list of valid crafting building entities for this runner
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256[] memory value) {
        if (has(entity)) {
            Layout memory s = CraftingBuildingTransformConfigComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete CraftingBuildingTransformConfigComponentStorage
            .layout()
            .entityIdToStruct[entity];
