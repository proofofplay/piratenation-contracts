...
uint256 constant ID = uint256(
    keccak256("game.piratenation.transformconfigtimelockcomponent.v1")
);
...
library TransformConfigTimeLockComponentStorage {
...
/**
 * @title TransformConfigTimeLockComponent
 * @dev Time lock configuration for a transform
 */
contract TransformConfigTimeLockComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // The time lock value in seconds
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value The time lock value in seconds
     */
    function setValue(
        uint256 entity,
        uint32 value
    ...
    function getLayoutValue(
        ...
        value = TransformConfigTimeLockComponentStorage
            .layout()
     ...
     *
     * @param entity Entity to get value for
     * @return value The time lock value in seconds
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint32 value) {
        if (has(entity)) {
            Layout memory s = TransformConfigTimeLockComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = TransformConfigTimeLockComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete TransformConfigTimeLockComponentStorage
            .layout()
            .entityIdToStruct[entity];
