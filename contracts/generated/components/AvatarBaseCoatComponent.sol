...
uint256 constant ID = uint256(
    keccak256("game.piratenation.avatarbasecoatcomponent.v1")
);
...
library AvatarBaseCoatComponentStorage {
...
/**
 * @title AvatarBaseCoatComponent
 * @dev The base coat of the avatar
 */
contract AvatarBaseCoatComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Entity that has the coat information for this entity&#39;s avatar
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Entity that has the coat information for this entity&#39;s avatar
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = AvatarBaseCoatComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Entity that has the coat information for this entity&#39;s avatar
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = AvatarBaseCoatComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = AvatarBaseCoatComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete AvatarBaseCoatComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete AvatarBaseCoatComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
