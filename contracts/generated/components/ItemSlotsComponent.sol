...
uint256 constant ID = uint256(
    keccak256("game.piratenation.itemslotscomponent.v1")
);
...
library ItemSlotsComponentStorage {
...
/**
 * @title ItemSlotsComponent
 * @dev How many equippable item slots this entity has
 */
contract ItemSlotsComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = ItemSlotsComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = ItemSlotsComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = ItemSlotsComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getBytes(
        ...
        Layout memory s = ItemSlotsComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete ItemSlotsComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete ItemSlotsComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
