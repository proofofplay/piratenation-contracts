...
uint256 constant ID = uint256(
    keccak256("game.piratenation.gemtransformcompleteeligiblecomponent.v1")
);
...
library GemTransformCompleteEligibleComponentStorage {
...
/**
 * @title GemTransformCompleteEligibleComponent
 * @dev Define if a transform is eligible for gems completion
 */
contract GemTransformCompleteEligibleComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Whether the transform is eligible for gems completion or not (default is false)
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Whether the transform is eligible for gems completion or not (default is false)
     */
    function setValue(
        uint256 entity,
        bool value
    ...
    function getLayoutValue(
        ...
        value = GemTransformCompleteEligibleComponentStorage
            .layout()
     ...
     *
     * @param entity Entity to get value for
     * @return value Whether the transform is eligible for gems completion or not (default is false)
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (bool value) {
        if (has(entity)) {
            Layout memory s = GemTransformCompleteEligibleComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = GemTransformCompleteEligibleComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete GemTransformCompleteEligibleComponentStorage
            .layout()
            .entityIdToStruct[entity];
