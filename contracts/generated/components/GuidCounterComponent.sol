...
uint256 constant ID = uint256(
    keccak256("game.piratenation.guidcountercomponent.v1")
);
...
contract GuidCounterComponent is BaseStorageComponentV2 {
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = GuidCounterComponentStorage
                .layout()
    ...
    function getBytes(
        ...
        Layout memory s = GuidCounterComponentStorage.layout().entityIdToStruct[
            entity
        ];
