...
contract EnergyComponent is BaseStorageComponentV2 {
     ...
     *
     * @param entity Entity to get value for
     * @param lastEnergyAmount Energy amount at time of last spend
     * @param lastSpendTimestamp Timestamp the energy was last spent
     * @param lastEnergyEarnable Energy allowed to be earned
     * @param lastEarnTimestamp Last time energy was earned
     */
    function setValue(
        uint256 entity,
        uint256 lastEnergyAmount,
     ...
     *
     * @param entity Entity to get value for
     * @return lastEnergyAmount Energy amount at time of last spend
     * @return lastSpendTimestamp Timestamp the energy was last spent
     * @return lastEnergyEarnable Energy allowed to be earned
     * @return lastEarnTimestamp Last time energy was earned
     */
    function getValue(
        uint256 entity
    )
    ...
    function getByteValues(
        ...
        values = new bytes[](4);
        values[0] = abi.encode(s.lastEnergyAmount);
        values[1] = abi.encode(s.lastSpendTimestamp);
        values[2] = abi.encode(s.lastEnergyEarnable);
        values[3] = abi.encode(s.lastEarnTimestamp);
    }
    ...
    function setBytes(
        ...
        (
            s.lastEnergyAmount,
            s.lastSpendTimestamp,
            s.lastEnergyEarnable,
            s.lastEarnTimestamp
    ...
    function _setValueToStorage(uint256 entity, Layout memory value) internal {
        ...
        s.lastEnergyAmount = value.lastEnergyAmount;
        s.lastSpendTimestamp = value.lastSpendTimestamp;
        s.lastEnergyEarnable = value.lastEnergyEarnable;
        s.lastEarnTimestamp = value.lastEarnTimestamp;
    }
    ...
    function _setValue(uint256 entity, Layout memory value) internal {
        ...
        _emitSetBytes(
            entity,
            abi.encode(
                value.lastEnergyAmount,
                value.lastSpendTimestamp,
                value.lastEnergyEarnable,
                value.lastEarnTimestamp
            )
        );
    }
