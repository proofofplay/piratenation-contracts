...
uint256 constant ID = uint256(
    keccak256("game.piratenation.avatarbaseskincomponent.v1")
);
...
library AvatarBaseSkinComponentStorage {
...
/**
 * @title AvatarBaseSkinComponent
 * @dev The base skin of the avatar
 */
contract AvatarBaseSkinComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Entity that has the skin information for this entity&#39;s avatar
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Entity that has the skin information for this entity&#39;s avatar
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = AvatarBaseSkinComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Entity that has the skin information for this entity&#39;s avatar
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = AvatarBaseSkinComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = AvatarBaseSkinComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete AvatarBaseSkinComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete AvatarBaseSkinComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
