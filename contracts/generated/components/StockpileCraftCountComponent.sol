...
uint256 constant ID = uint256(
    keccak256("game.piratenation.stockpilecraftcountcomponent.v1")
);
...
library StockpileCraftCountComponentStorage {
...
/**
 * @title StockpileCraftCountComponent
 * @dev Track the number of times an entity has crafted a stockpile
 */
contract StockpileCraftCountComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // The number of times the entity has crafted a stockpile
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value The number of times the entity has crafted a stockpile
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = StockpileCraftCountComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value The number of times the entity has crafted a stockpile
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = StockpileCraftCountComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = StockpileCraftCountComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete StockpileCraftCountComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete StockpileCraftCountComponentStorage
                .layout()
                .entityIdToStruct[entities[i]];
        }
