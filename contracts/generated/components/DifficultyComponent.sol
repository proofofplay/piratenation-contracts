...
uint256 constant ID = uint256(
    keccak256("game.piratenation.difficultycomponent.v1")
);
...
library DifficultyComponentStorage {
...
/**
 * @title DifficultyComponent
 * @dev The difficulty of an entity
 */
contract DifficultyComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = DifficultyComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = DifficultyComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = DifficultyComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getBytes(
        ...
        Layout memory s = DifficultyComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete DifficultyComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete DifficultyComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
