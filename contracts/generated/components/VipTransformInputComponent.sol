...
uint256 constant ID = uint256(
    keccak256("game.piratenation.viptransforminputcomponent.v1")
);
...
library VipTransformInputComponentStorage {
...
contract VipTransformInputComponent is BaseStorageComponentV2 {
    ...
    function append(
        ...
        Layout storage s = VipTransformInputComponentStorage
            .layout()
    ...
    function removeValueAtIndex(
        ...
        if (index != lastIndexInArray) {
            s.inputEntity[index] = s.inputEntity[lastIndexInArray];
            s.inputType[index] = s.inputType[lastIndexInArray];
    ...
    function getLayoutValue(
        ...
        value = VipTransformInputComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
    ...
    {
        if (has(entity)) {
            Layout memory s = VipTransformInputComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete VipTransformInputComponentStorage.layout().entityIdToStruct[
            entity
        ];
