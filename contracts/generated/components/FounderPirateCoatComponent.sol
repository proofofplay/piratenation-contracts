...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpiratecoatcomponent.v1")
);
...
library FounderPirateCoatComponentStorage {
...
/**
 * @title FounderPirateCoatComponent
 * @dev The coat of the founder pirate
 */
contract FounderPirateCoatComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateCoatComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateCoatComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateCoatComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateCoatComponentStorage.layout().entityIdToStruct[
            entity
        ];
