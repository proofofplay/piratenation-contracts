...
uint256 constant ID = uint256(
    keccak256("game.piratenation.itemslotsperlevelcomponent.v1")
);
...
library ItemSlotsPerLevelComponentStorage {
...
/**
 * @title ItemSlotsPerLevelComponent
 * @dev How many equippable item slots this entity has per level
 */
contract ItemSlotsPerLevelComponent is BaseStorageComponentV2 {
    /** SETUP **/
     ...
     *
     * @param entity Entity to get value for
     * @param value Array of item slots per level
     */
    function setValue(
        uint256 entity,
    ...
    function append(
        ...
        Layout storage s = ItemSlotsPerLevelComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = ItemSlotsPerLevelComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Array of item slots per level
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256[] memory value) {
        if (has(entity)) {
            Layout memory s = ItemSlotsPerLevelComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete ItemSlotsPerLevelComponentStorage.layout().entityIdToStruct[
            entity
        ];
