...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpirateskincomponent.v1")
);
...
library FounderPirateSkinComponentStorage {
...
/**
 * @title FounderPirateSkinComponent
 * @dev The skin of the founder pirate
 */
contract FounderPirateSkinComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateSkinComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateSkinComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateSkinComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateSkinComponentStorage.layout().entityIdToStruct[
            entity
        ];
