...
uint256 constant ID = uint256(
    keccak256("game.piratenation.energypackcountcomponent.v1")
);
...
library EnergyPackCountComponentStorage {
...
/**
 * @title EnergyPackCountComponent
 * @dev Track the energy pack purchases for a wallet
 */
contract EnergyPackCountComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Track the count of energy pack purchases
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Track the count of energy pack purchases
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = EnergyPackCountComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Track the count of energy pack purchases
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = EnergyPackCountComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = EnergyPackCountComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete EnergyPackCountComponentStorage.layout().entityIdToStruct[
            entity
        ];
