...
uint256 constant ID = uint256(
    keccak256("game.piratenation.generationcomponent.v1")
);
...
library GenerationComponentStorage {
...
/**
 * @title GenerationComponent
 * @dev The generation of an entity
 */
contract GenerationComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = GenerationComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = GenerationComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = GenerationComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getBytes(
        ...
        Layout memory s = GenerationComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete GenerationComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete GenerationComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
