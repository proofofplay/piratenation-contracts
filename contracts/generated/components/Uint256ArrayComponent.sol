...
uint256 constant ID = uint256(
    keccak256("game.piratenation.uint256arraycomponent.v1")
);
...
library Uint256ArrayComponentStorage {
...
/**
 * @title Uint256ArrayComponent
 * @dev A generic uint256 array value of an entity
 */
contract Uint256ArrayComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function append(
        ...
        Layout storage s = Uint256ArrayComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = Uint256ArrayComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = Uint256ArrayComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete Uint256ArrayComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete Uint256ArrayComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
