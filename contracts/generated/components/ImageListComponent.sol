...
contract ImageListComponent is BaseStorageComponentV2 {
    ...
    function removeValueAtIndex(
        ...
        if (index != lastIndexInArray) {
            s.name[index] = s.name[lastIndexInArray];
            s.url[index] = s.url[lastIndexInArray];
            s.mimeType[index] = s.mimeType[lastIndexInArray];
            s.width[index] = s.width[lastIndexInArray];
            s.height[index] = s.height[lastIndexInArray];
        }
