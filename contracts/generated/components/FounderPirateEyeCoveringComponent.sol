...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpirateeyecoveringcomponent.v1")
);
...
library FounderPirateEyeCoveringComponentStorage {
...
/**
 * @title FounderPirateEyeCoveringComponent
 * @dev The eye covering of the founder pirate
 */
contract FounderPirateEyeCoveringComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateEyeCoveringComponentStorage
            .layout()
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateEyeCoveringComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateEyeCoveringComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateEyeCoveringComponentStorage
            .layout()
            .entityIdToStruct[entity];
