...
uint256 constant ID = uint256(
    keccak256("game.piratenation.transformcraftingbuildingtrackercomponent.v1")
);
...
library TransformCraftingBuildingTrackerComponentStorage {
...
/**
 * @title TransformCraftingBuildingTrackerComponent
 * @dev Track the data associated with a building craft transform
 */
contract TransformCraftingBuildingTrackerComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // The instance entity used for the building craft
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value The instance entity used for the building craft
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = TransformCraftingBuildingTrackerComponentStorage
            .layout()
     ...
     *
     * @param entity Entity to get value for
     * @return value The instance entity used for the building craft
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = TransformCraftingBuildingTrackerComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = TransformCraftingBuildingTrackerComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete TransformCraftingBuildingTrackerComponentStorage
            .layout()
            .entityIdToStruct[entity];
