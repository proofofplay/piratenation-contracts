...
uint256 constant ID = uint256(
    keccak256("game.piratenation.isshipcomponent.v1")
);
...
library IsShipComponentStorage {
...
/**
 * @title IsShipComponent
 * @dev Used to distinguish mixins for ships
 */
contract IsShipComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Whether or not this entity is a ship
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Whether or not this entity is a ship
     */
    function setValue(
        uint256 entity,
        bool value
    ...
    function getLayoutValue(
        ...
        value = IsShipComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Whether or not this entity is a ship
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (bool value) {
        if (has(entity)) {
            Layout memory s = IsShipComponentStorage.layout().entityIdToStruct[
                entity
            ];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = IsShipComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete IsShipComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete IsShipComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
