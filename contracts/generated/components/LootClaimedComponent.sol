...
uint256 constant ID = uint256(
    keccak256("game.piratenation.lootclaimedcomponent")
);
...
library LootClaimedComponentStorage {
...
/**
 * @title LootClaimedComponent
 * @dev Component for tracking loot claimed by an entity
 */
contract LootClaimedComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Array of loot claimed by an entity
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Array of loot claimed by an entity
     */
    function setValue(
        uint256 entity,
    ...
    function append(
        ...
        Layout storage s = LootClaimedComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = LootClaimedComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Array of loot claimed by an entity
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256[] memory value) {
        if (has(entity)) {
            Layout memory s = LootClaimedComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getBytes(
        ...
        Layout memory s = LootClaimedComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete LootClaimedComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete LootClaimedComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
