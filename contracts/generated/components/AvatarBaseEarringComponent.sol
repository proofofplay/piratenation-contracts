...
uint256 constant ID = uint256(
    keccak256("game.piratenation.avatarbaseearringcomponent.v1")
);
...
library AvatarBaseEarringComponentStorage {
...
/**
 * @title AvatarBaseEarringComponent
 * @dev The base earring of the avatar
 */
contract AvatarBaseEarringComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Entity that has the earring information for this entity&#39;s avatar
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Entity that has the earring information for this entity&#39;s avatar
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = AvatarBaseEarringComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Entity that has the earring information for this entity&#39;s avatar
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = AvatarBaseEarringComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = AvatarBaseEarringComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete AvatarBaseEarringComponentStorage.layout().entityIdToStruct[
            entity
        ];
