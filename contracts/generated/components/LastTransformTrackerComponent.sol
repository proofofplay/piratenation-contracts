...
uint256 constant ID = uint256(
    keccak256("game.piratenation.lasttransformtrackercomponent.v1")
);
...
library LastTransformTrackerComponentStorage {
...
/**
 * @title LastTransformTrackerComponent
 * @dev Track the last transform run
 */
contract LastTransformTrackerComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Entity ID of the last transform run
     ...
     *
     * @param entity Entity to get value for
     * @param transformEntity Entity ID of the last transform run
     * @param success Whether the transform was successful
     */
    function setValue(
        uint256 entity,
        uint256 transformEntity,
    ...
    function getLayoutValue(
        ...
        value = LastTransformTrackerComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return transformEntity Entity ID of the last transform run
     * @return success Whether the transform was successful
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 transformEntity, bool success) {
        if (has(entity)) {
            Layout memory s = LastTransformTrackerComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = LastTransformTrackerComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete LastTransformTrackerComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete LastTransformTrackerComponentStorage
                .layout()
                .entityIdToStruct[entities[i]];
        }
