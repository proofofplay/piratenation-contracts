...
uint256 constant ID = uint256(
    keccak256("game.piratenation.imagesvgurlcomponent.v1")
);
...
library ImageSvgUrlComponentStorage {
...
/**
 * @title ImageSvgUrlComponent
 * @dev SVG image for the entity
 */
contract ImageSvgUrlComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = ImageSvgUrlComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = ImageSvgUrlComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = ImageSvgUrlComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function getBytes(
        ...
        Layout memory s = ImageSvgUrlComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete ImageSvgUrlComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete ImageSvgUrlComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
