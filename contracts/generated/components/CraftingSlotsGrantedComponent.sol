...
uint256 constant ID = uint256(
    keccak256("game.piratenation.craftingslotsgrantedcomponent.v1")
);
...
library CraftingSlotsGrantedComponentStorage {
...
/**
 * @title CraftingSlotsGrantedComponent
 * @dev Set the number of crafting slots granted by an entity
 */
contract CraftingSlotsGrantedComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Amount of crafting slots granted by this entity
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Amount of crafting slots granted by this entity
     */
    function setValue(
        uint256 entity,
        uint256 value
    ...
    function getLayoutValue(
        ...
        value = CraftingSlotsGrantedComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Amount of crafting slots granted by this entity
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 value) {
        if (has(entity)) {
            Layout memory s = CraftingSlotsGrantedComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = CraftingSlotsGrantedComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete CraftingSlotsGrantedComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete CraftingSlotsGrantedComponentStorage
                .layout()
                .entityIdToStruct[entities[i]];
        }
