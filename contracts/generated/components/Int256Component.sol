...
uint256 constant ID = uint256(
    keccak256("game.piratenation.int256component.v1")
);
...
library Int256ComponentStorage {
...
/**
 * @title Int256Component
 * @dev A generic int256 value of an entity
 */
contract Int256Component is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = Int256ComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = Int256ComponentStorage.layout().entityIdToStruct[
                entity
            ];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = Int256ComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete Int256ComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete Int256ComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
