...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpirateearringcomponent.v1")
);
...
library FounderPirateEarringComponentStorage {
...
/**
 * @title FounderPirateEarringComponent
 * @dev The earring of the founder pirate
 */
contract FounderPirateEarringComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateEarringComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateEarringComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateEarringComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateEarringComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete FounderPirateEarringComponentStorage
                .layout()
                .entityIdToStruct[entities[i]];
        }
