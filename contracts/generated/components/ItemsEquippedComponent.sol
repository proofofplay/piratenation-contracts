...
uint256 constant ID = uint256(
    keccak256("game.piratenation.itemsequippedcomponent.v1")
);
...
library ItemsEquippedComponentStorage {
...
/**
 * @title ItemsEquippedComponent
 * @dev The equipment items of an entity
 */
contract ItemsEquippedComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Array of item entities equipped to an entity
        keys[0] = "value";
     ...
     *
     * @param entity Entity to get value for
     * @param value Array of item entities equipped to an entity
     */
    function setValue(
        uint256 entity,
    ...
    function append(
        ...
        Layout storage s = ItemsEquippedComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = ItemsEquippedComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return value Array of item entities equipped to an entity
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256[] memory value) {
        if (has(entity)) {
            Layout memory s = ItemsEquippedComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete ItemsEquippedComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete ItemsEquippedComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
