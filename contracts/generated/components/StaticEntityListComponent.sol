...
uint256 constant ID = uint256(
    keccak256("game.piratenation.staticentitylistcomponent.v1")
);
...
library StaticEntityListComponentStorage {
...
/**
 * @title StaticEntityListComponent
 * @dev A list of entities for static data
 */
contract StaticEntityListComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function append(
        ...
        Layout storage s = StaticEntityListComponentStorage
            .layout()
    ...
    function getLayoutValue(
        ...
        value = StaticEntityListComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = StaticEntityListComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete StaticEntityListComponentStorage.layout().entityIdToStruct[
            entity
        ];
