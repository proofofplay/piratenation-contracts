...
uint256 constant ID = uint256(
    keccak256("game.piratenation.combatstatuseffectdurationcomponent.v1")
);
...
library CombatStatusEffectDurationComponentStorage {
...
/**
 * @title CombatStatusEffectDurationComponent
 * @dev Combat Status Effect Duration is a component that defines data for a effect duration of a specific effect
 */
contract CombatStatusEffectDurationComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = CombatStatusEffectDurationComponentStorage
            .layout()
    ...
    {
        if (has(entity)) {
            Layout memory s = CombatStatusEffectDurationComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = CombatStatusEffectDurationComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete CombatStatusEffectDurationComponentStorage
            .layout()
            .entityIdToStruct[entity];
