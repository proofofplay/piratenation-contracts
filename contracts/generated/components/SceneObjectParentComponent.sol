 ...
 */
contract SceneObjectParentComponent is BaseStorageComponentV2 {
    /** SETUP **/
     ...
     *
     * @param entity Entity to get value for
     * @param parentEntity Entity ID of the parent
     */
    function setValue(
        uint256 entity,
        uint256 parentEntity
     ...
     *
     * @param entity Entity to get value for
     * @return parentEntity Entity ID of the parent
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (uint256 parentEntity) {
        if (has(entity)) {
            Layout memory s = SceneObjectParentComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = SceneObjectParentComponentStorage
            .layout()
            .entityIdToStruct[entity];
