...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpirateheadwearcomponent.v1")
);
...
library FounderPirateHeadwearComponentStorage {
...
/**
 * @title FounderPirateHeadwearComponent
 * @dev The headwear of the founder pirate
 */
contract FounderPirateHeadwearComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateHeadwearComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateHeadwearComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateHeadwearComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateHeadwearComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete FounderPirateHeadwearComponentStorage
                .layout()
