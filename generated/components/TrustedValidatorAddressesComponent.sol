    ...
    function removeValueAtIndexes(
        ...
        for (uint256 i = 0; i < indexes.length; i++) {
            ...
            if (indexToRemove != lastIndexInArray) {
                s.serverPublicAddresses[indexToRemove] = s
                    .serverPublicAddresses[lastIndexInArray];
                s.hosts[indexToRemove] = s.hosts[lastIndexInArray];
                s.ports[indexToRemove] = s.ports[lastIndexInArray];
                s.hasMultiplayerPirates[indexToRemove] = s
                    .hasMultiplayerPirates[lastIndexInArray];
                s.hasSsl[indexToRemove] = s.hasSsl[lastIndexInArray];
            }
            // Pop the last value
