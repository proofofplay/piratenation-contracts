...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpiratemagegemcomponent.v1")
);
...
library FounderPirateMageGemComponentStorage {
...
/**
 * @title FounderPirateMageGemComponent
 * @dev The mage gem of the founder pirate
 */
contract FounderPirateMageGemComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateMageGemComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateMageGemComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateMageGemComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateMageGemComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete FounderPirateMageGemComponentStorage
                .layout()
