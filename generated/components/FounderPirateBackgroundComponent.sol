...
uint256 constant ID = uint256(
    keccak256("game.piratenation.founderpiratebackgroundcomponent.v1")
);
...
library FounderPirateBackgroundComponentStorage {
...
/**
 * @title FounderPirateBackgroundComponent
 * @dev The background of the founder pirate
 */
contract FounderPirateBackgroundComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = FounderPirateBackgroundComponentStorage
            .layout()
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = FounderPirateBackgroundComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = FounderPirateBackgroundComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete FounderPirateBackgroundComponentStorage
            .layout()
            .entityIdToStruct[entity];
