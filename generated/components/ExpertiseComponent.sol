...
uint256 constant ID = uint256(
    keccak256("game.piratenation.expertisecomponent.v1")
);
...
library ExpertiseComponentStorage {
...
/**
 * @title ExpertiseComponent
 * @dev The expertise of this entity. Used in combat
 */
contract ExpertiseComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = ExpertiseComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = ExpertiseComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = ExpertiseComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getBytes(
        ...
        Layout memory s = ExpertiseComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete ExpertiseComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete ExpertiseComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
